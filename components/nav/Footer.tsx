      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-neutral-400 text-sm">
              Din reise mot en sunnere livsstil starter her. Bli medlem av vårt inkluderende fellesskap og nå dine mål.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/ansatte" className="text-neutral-400 hover:text-white">
                  Ansatte
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/program" className="text-neutral-400 hover:text-white">
                  Program
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-neutral-400">
              <li className="flex items-start">
                ...
                <span>123 Fitness Street<br />Oslo, Norway 0123</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>info@treningsglede.no</span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-neutral-400 text-sm">
              © {new Date().getFullYear()} Treningsglede. All rights reserved.
            </p>
